...
(function($) {
  ...
  THEMEMASCOT.header = {
    ...
    TM_fullscreenMenu: function() {
      ...
      menuItemWithChild.find('.indicator').children('i').removeClass('bi bi-chevron-down').addClass('arrow_right');
    ...
    TM_menuzord: function() {
      ...
      if( $menuzord.length > 0 ) {
        $menuzord.menuzord({
          ...
          effect: "slide",
          animation: "none",
          indicatorFirstLevel: "<i class='bi bi-chevron-down'></i>",
          indicatorSecondLevel: "<i class='bi bi-chevron-left'></i>"
        });
      }
      ...
      if ( $slick_carousel_1col.length > 0 ) {
        $slick_carousel_1col.each(function() {
          ...
          $this.slick({
            ...
            adaptiveHeight: true,
            easing:'easeOutCubic',
            prevArrow: '<span class="tm-slick-prev tm-prev-icon"><i class="bi bi-chevron-left"></i></span>',
            nextArrow: '<span class="tm-slick-next tm-next-icon"><i class="bi bi-chevron-left"></i></span>',
            responsive: [
              {
                breakpoint: 1024,
                settings: {
      ...
      if( $bxslider.length > 0 ) {
        $bxslider.each(function() {
          ...
          $this.bxSlider({
            ...
            nextText: '<i class="bi bi-chevron-left"></i>'
          });
        });
      }
    },
